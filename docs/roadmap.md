...
Положительный результат устойчив по untrimmed costs, границам окон и 10/11 соседним вариантам. Однако frozen rolling после удаления top-5 отрицателен при расходах 0,10–0,16%, поэтому строгий критерий Phase 3 не выполнен. Кандидат остаётся исследовательским; TEST закрыт до отдельного явного решения.
